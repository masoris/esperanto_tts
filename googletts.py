...
def vocalwave_tts_esperanto(esp_txt, voicename, output_mp3):
    ...
    url = "https://cache-a.oddcast.com/tts/gen.php?EID=2&LID=31&VID=1&TXT=" + \
        quote(esp_txt) + "&IS_UTF8=1&ACC=3314795&API=2292376&CB=vw_mc.vwCallback&HTTP_ERR=1&vwApiVersion=2&d=f88dda1b76a1b76931320d9f8810330ee9f6df88dd"
